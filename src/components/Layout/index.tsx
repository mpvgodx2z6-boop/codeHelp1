    ...
    return (
        ...
        >
            <Layout style={{ minHeight: '100vh' }}>
                <Sider theme={curTheme ? 'dark' : 'light'} breakpoint="lg" collapsedWidth="0" onBreakpoint={() => {}} onCollapse={() => {}}>
                ...
                <Layout>
                    <Header style={{ padding: 0, ...getThemeBg(curTheme), display: 'flex' }}>
                        <div className={styles.rightControl}>
                            <span onClick={toggleTheme} className={styles.theme} title="切换主题">
                                {!curTheme ? <SunOutlined style={{ color: colorWarningText }} /> : <MoonOutlined style={{ color: colorTextBase }} />}
                            </span>
                    ...
                    <Footer style={{ textAlign: 'center' }}>Prompt-Tool ©{new Date().getFullYear()}</Footer>
                </Layout>
            </Layout>
        </ConfigProvider>
    );
